...
All dependencies are listed in requirements.txt and can be installed via pip, using a python virtual environment is recommended (https://docs.python.org/3/library/venv.html):
